  ...
  return (
    <div style={{ paddingTop: '100px', paddingBottom: '60px', padding: '100px 24px 60px', backgroundColor: '#f7f3ed', minHeight: '100vh' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ backgroundColor: '#faf5ef', border: '1px solid #e8dcc8', borderRadius: '20px', padding: '48px 32px', marginBottom: '32px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
          {[
            ...
            <div key={i} style={{ backgroundColor: '#faf5ef', border: '1px solid #e8dcc8', borderRadius: '12px', padding: '28px 16px', textAlign: 'center' }}>
